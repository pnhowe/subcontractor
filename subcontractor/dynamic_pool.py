...
class DynamicPool():
  def __init__( self, gateway, netmask, dns_server, boot_file, lease_time ):  # lease_time in seconds
    super().__init__()
  ...
  def lookup( self, mac ):
    ...
    return ( address, self.netmask, self.gateway, self.dns_server, self.boot_file )
